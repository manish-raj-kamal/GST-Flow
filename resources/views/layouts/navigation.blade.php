...
<aside id="app-sidebar"
       class="gst-sidebar scrollbar-thin"
    ...
    <button type="button"
        ...
        <svg class="h-4 w-4 transition-transform" :class="{ 'rotate-180': sidebarCollapsed }" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <nav class="gst-sidebar-nav">
        ...
        <a href="{{ route('business-profiles') }}" class="nav-item {{ $currentRoute === 'business-profiles' ? 'active' : '' }}" aria-label="Business Profiles" title="Business Profiles">
            ...
            <span class="nav-label">Business Profiles</span>
        </a>
        <a href="{{ route('customers') }}" class="nav-item {{ $currentRoute === 'customers' ? 'active' : '' }}" aria-label="Customers" title="Customers">
            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            <span class="nav-label">Customers</span>
        </a>

        <div class="nav-section-title">Catalog</div>
        <a href="{{ route('products') }}" class="nav-item {{ $currentRoute === 'products' ? 'active' : '' }}" aria-label="Products" title="Products">
        ...
        <a href="{{ route('hsn-codes') }}" class="nav-item {{ $currentRoute === 'hsn-codes' ? 'active' : '' }}" aria-label="HSN Codes" title="HSN Codes">
            ...
            <span class="nav-label">HSN Codes</span>
        </a>
        <a href="{{ route('tax-slabs') }}" class="nav-item {{ $currentRoute === 'tax-slabs' ? 'active' : '' }}" aria-label="Tax Slabs" title="Tax Slabs">
            ...
            <span class="nav-label">Tax Slabs</span>
        </a>

        <div class="nav-section-title">Transactions</div>
        <a href="{{ route('invoices') }}" class="nav-item {{ str_starts_with($currentRoute, 'invoices') ? 'active' : '' }}" aria-label="Invoices" title="Invoices">
        ...
        <a href="{{ route('gstin-validator') }}" class="nav-item {{ $currentRoute === 'gstin-validator' ? 'active' : '' }}" aria-label="GSTIN Validator" title="GSTIN Validator">
            ...
            <span class="nav-label">GSTIN Validator</span>
        </a>

        <div class="nav-section-title">Reports</div>
        <a href="{{ route('reports') }}" class="nav-item {{ $currentRoute === 'reports' ? 'active' : '' }}" aria-label="Reports" title="Reports">
        ...
        <a href="{{ route('gstr-summary') }}" class="nav-item {{ $currentRoute === 'gstr-summary' ? 'active' : '' }}" aria-label="GSTR Summary" title="GSTR Summary">
            ...
            <span class="nav-label">GSTR Summary</span>
        </a>

        <div class="nav-section-title">System</div>
        <a href="{{ route('activity-logs') }}" class="nav-item {{ $currentRoute === 'activity-logs' ? 'active' : '' }}" aria-label="Activity Logs" title="Activity Logs">
        ...
        @if($isAdmin)
        <a href="{{ route('admin') }}" class="nav-item {{ $currentRoute === 'admin' ? 'active' : '' }}" aria-label="Admin Panel" title="Admin Panel">
        ...
        <a href="{{ route('documentation') }}" class="nav-item {{ $currentRoute === 'documentation' ? 'active' : '' }}" aria-label="Documentation" title="Documentation">
