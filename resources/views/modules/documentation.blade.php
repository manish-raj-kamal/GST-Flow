                    ...
                    <table class="data-table text-xs">
                        ...
                        <tbody>
                            ...
                            $routes = [
                                ...
                                ['GET', '/api/hsn/search?q=paneer', 'Intelligent HSN + GST product search', 'Yes'],
                                ['POST', '/api/hsn/search/select', 'Record selected HSN result', 'Yes'],
                                ['GET', '/api/hsn/analytics', 'HSN search analytics dashboard', 'Yes (Admin)'],
                                ['POST', '/api/hsn/import', 'Bulk import HSN products (CSV/XLS/XLSX)', 'Yes (Admin)'],
                                ['CRUD', '/api/hsn/products', 'HSN product enrichment management', 'Yes (Admin)'],
